...
describe('DefaultThreadApiClient', () => {
  ...
  describe('getThreads', () => {
    ...
    it('should fetch threads with query parameters', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        '/api/chat/threads?limit=10&offset=5&orderBy=createdAt&orderDirection=asc&search=test',
        expect.any(Object),
      );
    });
  ...
  describe('getThread', () => {
    ...
    it('should fetch a single thread', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(`/api/chat/threads/${threadId}`, expect.any(Object));
  ...
  describe('updateThread', () => {
    ...
    it('should update a thread', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(`/api/chat/threads/${threadId}`, {
        method: 'PUT',
        headers: expect.objectContaining({
          'Content-Type': 'application/json',
        }),
...
describe.skip('Thread Hooks', () => {
  ...
  describe('useThreads', () => {
    ...
    it('should fetch threads with custom options', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        '/api/chat/threads?limit=5&search=test',
        expect.any(Object),
      );
    });
